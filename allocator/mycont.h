...
class MyCont{
    ...
    static inline std::allocator_traits< typename Allocator:: template rebind<node>::other > nodeAllocTraits;
    static inline typename Allocator:: template rebind<node>::other nodeAlloc;
public:
    MyCont();
    //MyCont(const MyCont &rhv); Do we really need it?
    //MyCont(MyCont &&rhv);
    ~MyCont();
...
// template<typename T, typename Allocator>
// MyCont<T,Allocator>::MyCont(const MyCont &rhv){
//     assert(false);
//     // todo copy container
// }
...
// template<typename T, typename Allocator>
// MyCont<T,Allocator>::MyCont(MyCont &&rhv){
//     assert(false);
//     // todo move container
// }
