...
struct OptAllocator {
    ...
    template <typename U, typename V> OptAllocator(const OptAllocator<U, V>&) noexcept;
    ...
    static inline optlog<P::verb, 0> LOG_0;
    static inline optlog<P::verb, 1> LOG_1;
    static inline optlog<P::verb, 2> LOG_2;
    static inline optlog<P::verb, 3> LOG_3;
};
...
OptAllocator<T, P>::OptAllocator(const OptAllocator<U, V>&) noexcept {
    LOG_3 << __PRETTY_FUNCTION__ << std::endl;
}
